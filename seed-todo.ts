...
export const metadata: Metadata = {
  title: 'Todo List App',
  description: 'A Next.js todo list application',
}
...
export default function Home() {
  ...
  return (
    ...
    'src/components/todo-app.tsx': `'use client'
...
export function TodoApp() {
  ...
  console.log(`Seeded "Todo List App"! Project ID: ${project.id}`);
}
