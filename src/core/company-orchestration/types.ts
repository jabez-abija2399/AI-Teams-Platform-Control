...
export const VALID_STATE_TRANSITIONS: Record<ProjectLifecycleState, ProjectLifecycleState[]> = {
  ...
  ANALYSIS_RUNNING: ['DESIGN_RUNNING', 'FAILED', 'PAUSED'],
  DESIGN_RUNNING: ['ARCHITECTURE_RUNNING', 'FAILED', 'PAUSED'],
  ARCHITECTURE_RUNNING: ['PLANNING_RUNNING', 'FAILED', 'PAUSED'],
  PLANNING_RUNNING: ['DEVELOPMENT_RUNNING', 'FAILED', 'PAUSED'],
  ...
  COMPLETED: [],
  FAILED: ['DISCOVERY_RUNNING', 'STRATEGY_RUNNING', 'PRODUCT_RUNNING', 'ANALYSIS_RUNNING', 'DESIGN_RUNNING', 'ARCHITECTURE_RUNNING', 'PLANNING_RUNNING', 'DEVELOPMENT_RUNNING', 'TESTING_RUNNING', 'SECURITY_RUNNING', 'DEPLOYMENT_RUNNING', 'CREATED'],
  PAUSED: ['DISCOVERY_RUNNING', 'STRATEGY_RUNNING', 'PRODUCT_RUNNING', 'ANALYSIS_RUNNING', 'DESIGN_RUNNING', 'ARCHITECTURE_RUNNING', 'PLANNING_RUNNING', 'DEVELOPMENT_RUNNING', 'TESTING_RUNNING', 'SECURITY_RUNNING', 'DEPLOYMENT_RUNNING', 'MONITORING', 'FAILED', 'PROPOSAL_RUNNING'],
};
