...
export const VALID_TRANSITIONS: Record<ProjectPhase, ProjectPhase[]> = {
  CREATED: ['DISCOVERY', 'PLANNING', 'ARCHITECTURE', 'DESIGN', 'EXECUTION', 'FAILED', 'PAUSED'],
  ...
  EXECUTION: ['DEBATE', 'REVIEW', 'FAILED', 'PAUSED'],
  DEBATE: ['REVIEW', 'COMPLETED', 'FAILED', 'PAUSED', 'EXECUTION'],
