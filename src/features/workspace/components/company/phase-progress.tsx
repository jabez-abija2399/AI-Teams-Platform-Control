      ...
      {phases.map((phase, index) => (
        <div key={index} className="flex items-center">
          <div
            ...
            title={phase.name}
          >
            <div className="absolute -top-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-md bg-white/[0.1] px-2 py-1 text-[10px] text-foreground opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
              {phase.name}
            </div>
          </div>
