...
export function ArchitectureRoom({ projectId }: { projectId: string }) {
  ...
  return (
    <div className="flex h-full flex-col">
      <RoomHeader
        ...
        subtitle="Software Architect is designing the system"
            ...
            {isApproval && state.approvalRequests[0] && (() => {
              ...
              return (
                <div className="mt-4">
                  <ApprovalDialog
                    request={req}
                    onApprove={() => approve(req.artifactName || "ARCHITECTURE_APPROVAL")}
                    onRequestChanges={() => {}}
                    onReject={() => {}}
                  />
                </div>
